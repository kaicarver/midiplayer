...
(function (global) {
  ...
  function play_WebAudioAPI(url) {
    ...
    for (var i = 0; i < document.scripts.length; i++) {
	 ...
	 console.log("matched script_src=", script_src);
         midijs_url = script_src.substr(0, index);
	 // the above hack doesn't work: script_src=http://127.0.0.1:8887/Users/Kai/Documents/GitHub/midiplayer/js/midi/plugin.webmidi.js
